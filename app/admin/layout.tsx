...
const NAV_ITEMS = [
  ...
  { 
    ...
    label: "จัดการประกาศ", 
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 11 18-5v12L3 14v-3z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/></svg> 
  },
  { 
    href: "/admin/settings", 
        ...
        <div className="md:hidden fixed inset-0 z-[60] bg-[var(--bg-color)]/95 backdrop-blur-2xl animate-in slide-in-from-bottom-5 fade-in duration-300 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto pb-[max(env(safe-area-inset-bottom),24px)] pt-2 px-4 bg-transparent custom-scrollbar">
            ...
            {[
              ...
              { title: "ระบบและอื่นๆ", hrefs: ["/admin/announcements", "/admin/report", "/admin/settings"] }
            ].map((group, groupIdx) => (
